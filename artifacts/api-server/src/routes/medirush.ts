...
async function ensureOtcProducts() {
  ...
  const otc = [
    ...
    { id: "med_becosules",           name: "Becosules Capsule",           company: "GSK", catId: "cat_vitamins",         mrp: 48,    price: 43.20,   desc: "Vitamin B-complex + Vitamin C capsule for nutritional deficiency and energy metabolism." },
